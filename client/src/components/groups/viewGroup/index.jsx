import { Box, Button, Container, Divider, Fab, Grid, Link, Stack, styled, Typography, Avatar, AvatarGroup } from '@mui/material';
                        ...
                        <Stack direction="row" alignItems="center" spacing={1} mt={2}>
                             ...
                             <AvatarGroup max={6}>
                                 {group?.groupMembers?.map((member) => (
                                     <Avatar key={member} alt={member} src={gravatarUrl(member, { size: 350, default: dataConfig.USER_DEFAULT_LOGO_URL })} />
                                 ))}
                             </AvatarGroup>
                             <Button
